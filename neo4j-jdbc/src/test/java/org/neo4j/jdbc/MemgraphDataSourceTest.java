 ...
 * @since 3.0.0
 */
public class MemgraphDataSourceTest {

	@Rule public ExpectedException expectedEx = ExpectedException.none();

	private MemgraphDataSource dataSource;

	@Before public void setUp() {
		this.dataSource = mock(MemgraphDataSource.class, Mockito.CALLS_REAL_METHODS);
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		assertTrue(this.dataSource.isWrapperFor(MemgraphDataSource.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		assertFalse(this.dataSource.isWrapperFor(MemgraphResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		assertNotNull(this.dataSource.unwrap(MemgraphDataSource.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		this.dataSource.unwrap(MemgraphResultSet.class);
	}
