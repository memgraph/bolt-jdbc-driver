 ...
 * @since 3.0.0
 */
public class MemgraphResultSetTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		MemgraphResultSet resultSet = mock(MemgraphResultSet.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(resultSet.isWrapperFor(MemgraphResultSet.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(resultSet.isWrapperFor(MemgraphStatement.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(resultSet.unwrap(MemgraphResultSet.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		resultSet.unwrap(MemgraphStatement.class);
	}
