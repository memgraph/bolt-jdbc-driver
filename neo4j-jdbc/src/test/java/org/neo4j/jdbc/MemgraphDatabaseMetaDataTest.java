 ...
 * @since 3.0.0
 */
public class MemgraphDatabaseMetaDataTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		MemgraphDatabaseMetaData databaseMetaData = mock(MemgraphDatabaseMetaData.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(databaseMetaData.isWrapperFor(MemgraphDatabaseMetaData.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(databaseMetaData.isWrapperFor(MemgraphResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(databaseMetaData.unwrap(MemgraphDatabaseMetaData.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		databaseMetaData.unwrap(MemgraphResultSet.class);
	}
	...
	@Test public void getDriverVersionShouldBeCorrect() throws SQLException {
		MemgraphDatabaseMetaData databaseMetaData = new MemgraphDatabaseMetaData(null){};
	...
	@Test public void getDriverVersionShouldReturnNegativeNumberOnBadVersion() throws SQLException {
		MemgraphDatabaseMetaData databaseMetaData = mock(MemgraphDatabaseMetaData.class, withSettings().defaultAnswer(Mockito.CALLS_REAL_METHODS));
