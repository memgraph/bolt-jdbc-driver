...
public class BoltRoutingGraphDriver extends BoltGraphDriverImpl {
    ...
    static {
        try {
            BoltRoutingGraphDriver driver = new BoltRoutingGraphDriver();
    ...
    public BoltRoutingGraphDriver() throws SQLException {
        this(cache::getDriver);
    }

    public BoltRoutingGraphDriver(String prefix) {
        super(prefix);
        this.driverFactory = cache::getDriver;
    }

    BoltRoutingGraphDriver(DriverFactory driverFactory) throws SQLException {
