 ...
 * @since 3.0.0
 */
public class BoltGraphPreparedStatementTest {

	@Rule
	public ExpectedException expectedEx = ExpectedException.none();

	private BoltGraphPreparedStatement preparedStatementOneParam;
	private BoltGraphPreparedStatement preparedStatementTwoParams;

	private BoltGraphResultSet expectedResultSet;
	private ResultSetFactory resultSetFactory;

	@Before public void interceptBoltResultSetConstructor() throws SQLException {
		expectedResultSet = mock(BoltGraphResultSet.class);
		resultSetFactory = (debug, statement, iterator, params) -> expectedResultSet;
		preparedStatementOneParam = new BoltGraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1");
		preparedStatementTwoParams = new BoltGraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1+$2");
	}
	...
	@Test public void closeShouldCloseExistingResultSet() throws Exception {
		...
		BoltGraphConnectionImpl connection = mockOpenConnectionWithResult(mockedDriverResult);
		BoltGraphPreparedStatement prStatement = new BoltGraphPreparedStatement(connection, resultSetFactory, "");
	...
	@Test public void closeShouldNotCallCloseOnAnyResultSet() throws Exception {
		PreparedStatement prStatement = BoltGraphPreparedStatement.newInstance(false, mockOpenConnectionWithResult(null), "");
	...
	@Test public void isClosedShouldReturnFalseWhenCreated() throws SQLException {
		BoltGraphConnectionImpl connection = mockOpenConnection();
		PreparedStatement prStatement = new BoltGraphPreparedStatement(connection, resultSetFactory, "");
	...
	@Test public void getParameterMetaDataShouldReturnANewParameterMetaData() throws Exception {
		BoltGraphParameterMetaData parameterMetaData = (BoltGraphParameterMetaData) preparedStatementOneParam.getParameterMetaData();
	...
	@Test public void getResultSetConcurrencyShouldThrowExceptionWhenCalledOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltGraphPreparedStatement.newInstance(false, mockConnectionClosed(), "");
		statement.close();
	...
	@Test public void executeQueryShouldThrowExceptionWhenClosedConnection() throws SQLException {
		...
		PreparedStatement statement = BoltGraphPreparedStatement.newInstance(false, mockConnectionClosed(), "", 0, 0, 0);
	...
	@Test public void executeQueryShouldReturnCorrectResultSetStructureConnectionNotAutocommit() throws Exception {
		...
		PreparedStatement statement = new BoltGraphPreparedStatement(mockOpenConnectionWithResult(null), (debug, stmt, iterator, params) -> {
			assertFalse(debug);
			assertNotNull(stmt);
			assertNull(iterator);
	...
	@Test public void executeQueryShouldThrowExceptionOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltGraphPreparedStatement.newInstance(false, mockOpenConnection(), StatementData.STATEMENT_MATCH_ALL);
		statement.close();
	...
	@Test public void executeUpdateShouldRun() throws SQLException {
		...
		PreparedStatement statement = BoltGraphPreparedStatement
	...
	@Test public void executeShouldRunQuery() throws SQLException {
		BoltGraphPreparedStatement statement = mock(BoltGraphPreparedStatement.class);
	...
	@Test public void executeShouldThrowExceptionOnUpdateOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltGraphPreparedStatement.newInstance(false, mockOpenConnection(), StatementData.STATEMENT_CREATE);
		statement.close();
	...
	@Test public void getUpdateCountShouldReturnOne() throws SQLException {
		...
		BoltGraphPreparedStatement statement = new BoltGraphPreparedStatement(mockOpenConnectionWithResult(result), resultSetFactory, "RETURN 42");
		statement.executeUpdate();
	...
	@Test public void getUpdateCountShouldReturnMinusOne() throws SQLException {
		...
		BoltGraphPreparedStatement statement = new BoltGraphPreparedStatement(mockOpenConnection(), nullRsFactory, "RETURN 42");
	...
	@Test public void getResultSetShouldReturnNull() throws SQLException {
		BoltGraphStatement statement = mock(BoltGraphStatement.class);
	...
	@Test public void addBatchShouldAddParametersToStack() throws SQLException {
		BoltGraphPreparedStatement stmt = new BoltGraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1");
	...
	@Test public void addBatchShouldThrowExceptionIfClosedStatement() throws SQLException {
		...
		PreparedStatement stmt = BoltGraphPreparedStatement.newInstance(false, Mocker.mockOpenConnection(), "?");
		stmt.setInt(1, 1);
		stmt.close();
		stmt.addBatch();
	}
	...
	@Test public void executeBatchShouldWork() throws SQLException {
		...
		PreparedStatement stmt = BoltGraphPreparedStatement.newInstance(false, connection, "MATCH n WHERE id(n) = ? SET n.property=1");
		stmt.setInt(1, 1);
		stmt.addBatch();
		stmt.setInt(1, 2);
		stmt.addBatch();
	...
	@Test public void executeBatchShouldThrowExceptionOnError() throws SQLException {
		...
		BoltGraphConnection connection = (BoltGraphConnection) stmt.getConnection();
	...
	@Test public void executeBatchShouldThrowExceptionOnClosed() throws SQLException {
		...
		PreparedStatement stmt = BoltGraphPreparedStatement.newInstance(false, Mocker.mockConnectionClosed(), "?");
		stmt.setInt(1, 1);
		stmt.addBatch();
		stmt.setInt(1, 2);
		stmt.addBatch();
