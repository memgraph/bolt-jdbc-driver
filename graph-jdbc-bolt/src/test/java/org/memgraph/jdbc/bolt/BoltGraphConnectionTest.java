 ...
 * @since 3.0.0
 */
public class BoltGraphConnectionTest {

	@Rule public ExpectedException expectedEx = ExpectedException.none();

	private BoltGraphConnectionImpl openConnection;
	private BoltGraphConnectionImpl closedConnection;
	private BoltGraphConnectionImpl slowOpenConnection;
	private BoltGraphConnectionImpl exceptionOpenConnection;

	@Before public void setUp() {
		openConnection = new BoltGraphConnectionImpl(mockDriverOpen(), new Properties(), "");
		closedConnection = new BoltGraphConnectionImpl(mockDriverClosed(), new Properties(), "");
		slowOpenConnection = new BoltGraphConnectionImpl(mockDriverOpenSlow(), new Properties(), "");
		exceptionOpenConnection = new BoltGraphConnectionImpl(mockDriverException(), new Properties(), "");
	}
	...
	@Test public void closeShouldCloseConnection() throws SQLException {
		...
		Connection connection = new BoltGraphConnectionImpl(driver, new Properties(), "");
		connection.close();
	...
	@Test public void closeShouldThrowExceptionWhenDatabaseAccessErrorOccurred() throws SQLException {
		...
		Connection boltConnection = Mockito.mock(BoltGraphConnectionImpl.class);
		...
		Connection connectionFlatten = new BoltGraphConnectionImpl(session);
    ...
    */
	...
	@Test public void createStatementWithWrongSyntax() throws SQLException {
		try (Connection connection = new BoltGraphConnectionImpl(mockDriverOpen(), new Properties(), "")) {
			try {
