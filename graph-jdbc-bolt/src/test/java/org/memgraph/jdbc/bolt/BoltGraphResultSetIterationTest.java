 ...
 * @since 3.0.0
 */
public class BoltGraphResultSetIterationTest {
	...
	@Test public void nextShouldReturnFalseEmpty() throws SQLException {
		...
		ResultSet resultSet = BoltGraphResultSet.newInstance(false, null, Result);
	...
	@Test public void nextShouldThrowExceptionEmpty() throws SQLException {
		...
		ResultSet resultSet = BoltGraphResultSet.newInstance(false, null, null);
