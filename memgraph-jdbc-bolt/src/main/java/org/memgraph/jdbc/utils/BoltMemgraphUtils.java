 ...
 */
public class BoltMemgraphUtils {
    ...
    public static <R> R executeInTx(BoltMemgraphConnection connection,
                                    String sql,
    ...
    private static Result execute(BoltMemgraphConnection connection,
                                          String statement,
    ...
    public static boolean hasResultSet(BoltMemgraphConnection connection, String cypher) {
