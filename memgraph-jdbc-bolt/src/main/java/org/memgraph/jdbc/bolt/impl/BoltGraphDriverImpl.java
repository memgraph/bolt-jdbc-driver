 ...
 * @since 3.3.1
 */
public abstract class BoltGraphDriverImpl extends GraphDriver {
    ...
    protected BoltGraphDriverImpl(String prefix) {
        super(prefix);
    }
    ...
    public Connection connect(String url, Properties props) throws SQLException {
        ...
        if (acceptsURL(url)) {
            ...
            try {
                ...
                connection = BoltGraphConnectionImpl.newInstance(driver, info, url);
            } catch (Exception e) {
                if (driver != null) {
                    try {
                        driver.close();
