 ...
 * @since 3.0.0
 */
public class BoltProtocolGraphResultSetMetaData extends GraphResultSetMetaData {
	 ...
	 */
	private BoltProtocolGraphResultSetMetaData(List<Type> types, List<String> keys) {
		super(keys);
	...
	public static ResultSetMetaData newInstance(boolean debug, List<Type> types, List<String> keys) {
		ResultSetMetaData rsmd = new BoltProtocolGraphResultSetMetaData(types, keys);
		return (ResultSetMetaData) Proxy
				.newProxyInstance(BoltProtocolGraphResultSetMetaData.class.getClassLoader(), new Class[] { ResultSetMetaData.class }, new GraphInvocationHandler(rsmd, debug));
	}
