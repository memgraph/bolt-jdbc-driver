 ...
 * @since 3.0.0
 */
public class BoltMemgraphResultSetIterationTest {
	...
	@Test public void nextShouldReturnFalseEmpty() throws SQLException {
		...
		ResultSet resultSet = BoltMemgraphResultSet.newInstance(false, null, Result);
	...
	@Test public void nextShouldThrowExceptionEmpty() throws SQLException {
		...
		ResultSet resultSet = BoltMemgraphResultSet.newInstance(false, null, null);
