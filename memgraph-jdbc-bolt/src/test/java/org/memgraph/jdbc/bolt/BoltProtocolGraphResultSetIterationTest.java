 ...
 * @since 3.0.0
 */
public class BoltProtocolGraphResultSetIterationTest {
	...
	@Test public void nextShouldReturnFalseEmpty() throws SQLException {
		...
		ResultSet resultSet = BoltProtocolGraphResultSet.newInstance(false, null, Result);
	...
	@Test public void nextShouldThrowExceptionEmpty() throws SQLException {
		...
		ResultSet resultSet = BoltProtocolGraphResultSet.newInstance(false, null, null);
