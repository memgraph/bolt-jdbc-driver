 ...
 * @since 3.0.0
 */
public class BoltMemgraphConnectionTest {

	@Rule public ExpectedException expectedEx = ExpectedException.none();

	private BoltMemgraphConnectionImpl openConnection;
	private BoltMemgraphConnectionImpl closedConnection;
	private BoltMemgraphConnectionImpl slowOpenConnection;
	private BoltMemgraphConnectionImpl exceptionOpenConnection;

	@Before public void setUp() {
		openConnection = new BoltMemgraphConnectionImpl(mockDriverOpen(), new Properties(), "");
		closedConnection = new BoltMemgraphConnectionImpl(mockDriverClosed(), new Properties(), "");
		slowOpenConnection = new BoltMemgraphConnectionImpl(mockDriverOpenSlow(), new Properties(), "");
		exceptionOpenConnection = new BoltMemgraphConnectionImpl(mockDriverException(), new Properties(), "");
	}
	...
	@Test public void closeShouldCloseConnection() throws SQLException {
		...
		Connection connection = new BoltMemgraphConnectionImpl(driver, new Properties(), "");
		connection.close();
	...
	@Test public void closeShouldThrowExceptionWhenDatabaseAccessErrorOccurred() throws SQLException {
		...
		Connection boltConnection = Mockito.mock(BoltMemgraphConnectionImpl.class);
		...
		Connection connectionFlatten = new BoltMemgraphConnectionImpl(session);
    ...
    */
	...
	@Test public void createStatementWithWrongSyntax() throws SQLException {
		try (Connection connection = new BoltMemgraphConnectionImpl(mockDriverOpen(), new Properties(), "")) {
			try {
