 ...
 * @since 3.0.0
 */
public class BoltMemgraphPreparedStatementTest {

	@Rule
	public ExpectedException expectedEx = ExpectedException.none();

	private BoltMemgraphPreparedStatement preparedStatementOneParam;
	private BoltMemgraphPreparedStatement preparedStatementTwoParams;

	private BoltMemgraphResultSet expectedResultSet;
	private ResultSetFactory resultSetFactory;

	@Before public void interceptBoltResultSetConstructor() throws SQLException {
		expectedResultSet = mock(BoltMemgraphResultSet.class);
		resultSetFactory = (debug, statement, iterator, params) -> expectedResultSet;
		preparedStatementOneParam = new BoltMemgraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1");
		preparedStatementTwoParams = new BoltMemgraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1+$2");
	}
	...
	@Test public void closeShouldCloseExistingResultSet() throws Exception {
		...
		BoltMemgraphConnectionImpl connection = mockOpenConnectionWithResult(mockedDriverResult);
		BoltMemgraphPreparedStatement prStatement = new BoltMemgraphPreparedStatement(connection, resultSetFactory, "");
	...
	@Test public void closeShouldNotCallCloseOnAnyResultSet() throws Exception {
		PreparedStatement prStatement = BoltMemgraphPreparedStatement.newInstance(false, mockOpenConnectionWithResult(null), "");
	...
	@Test public void isClosedShouldReturnFalseWhenCreated() throws SQLException {
		BoltMemgraphConnectionImpl connection = mockOpenConnection();
		PreparedStatement prStatement = new BoltMemgraphPreparedStatement(connection, resultSetFactory, "");
	...
	@Test public void getParameterMetaDataShouldReturnANewParameterMetaData() throws Exception {
		BoltMemgraphParameterMetaData parameterMetaData = (BoltMemgraphParameterMetaData) preparedStatementOneParam.getParameterMetaData();
	...
	@Test public void getResultSetConcurrencyShouldThrowExceptionWhenCalledOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltMemgraphPreparedStatement.newInstance(false, mockConnectionClosed(), "");
		statement.close();
	...
	@Test public void executeQueryShouldThrowExceptionWhenClosedConnection() throws SQLException {
		...
		PreparedStatement statement = BoltMemgraphPreparedStatement.newInstance(false, mockConnectionClosed(), "", 0, 0, 0);
	...
	@Test public void executeQueryShouldReturnCorrectResultSetStructureConnectionNotAutocommit() throws Exception {
		...
		PreparedStatement statement = new BoltMemgraphPreparedStatement(mockOpenConnectionWithResult(null), (debug, stmt, iterator, params) -> {
			assertFalse(debug);
			assertNotNull(stmt);
			assertNull(iterator);
	...
	@Test public void executeQueryShouldThrowExceptionOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltMemgraphPreparedStatement.newInstance(false, mockOpenConnection(), StatementData.STATEMENT_MATCH_ALL);
		statement.close();
	...
	@Test public void executeUpdateShouldRun() throws SQLException {
		...
		PreparedStatement statement = BoltMemgraphPreparedStatement
	...
	@Test public void executeShouldRunQuery() throws SQLException {
		BoltMemgraphPreparedStatement statement = mock(BoltMemgraphPreparedStatement.class);
	...
	@Test public void executeShouldThrowExceptionOnUpdateOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltMemgraphPreparedStatement.newInstance(false, mockOpenConnection(), StatementData.STATEMENT_CREATE);
		statement.close();
	...
	@Test public void getUpdateCountShouldReturnOne() throws SQLException {
		...
		BoltMemgraphPreparedStatement statement = new BoltMemgraphPreparedStatement(mockOpenConnectionWithResult(result), resultSetFactory, "RETURN 42");
		statement.executeUpdate();
	...
	@Test public void getUpdateCountShouldReturnMinusOne() throws SQLException {
		...
		BoltMemgraphPreparedStatement statement = new BoltMemgraphPreparedStatement(mockOpenConnection(), nullRsFactory, "RETURN 42");
	...
	@Test public void getResultSetShouldReturnNull() throws SQLException {
		BoltMemgraphStatement statement = mock(BoltMemgraphStatement.class);
	...
	@Test public void addBatchShouldAddParametersToStack() throws SQLException {
		BoltMemgraphPreparedStatement stmt = new BoltMemgraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1");
	...
	@Test public void addBatchShouldThrowExceptionIfClosedStatement() throws SQLException {
		...
		PreparedStatement stmt = BoltMemgraphPreparedStatement.newInstance(false, Mocker.mockOpenConnection(), "?");
		stmt.setInt(1, 1);
		stmt.close();
		stmt.addBatch();
	}
	...
	@Test public void executeBatchShouldWork() throws SQLException {
		...
		PreparedStatement stmt = BoltMemgraphPreparedStatement.newInstance(false, connection, "MATCH n WHERE id(n) = ? SET n.property=1");
		stmt.setInt(1, 1);
		stmt.addBatch();
		stmt.setInt(1, 2);
		stmt.addBatch();
	...
	@Test public void executeBatchShouldThrowExceptionOnError() throws SQLException {
		...
		BoltMemgraphConnection connection = (BoltMemgraphConnection) stmt.getConnection();
	...
	@Test public void executeBatchShouldThrowExceptionOnClosed() throws SQLException {
		...
		PreparedStatement stmt = BoltMemgraphPreparedStatement.newInstance(false, Mocker.mockConnectionClosed(), "?");
		stmt.setInt(1, 1);
		stmt.addBatch();
		stmt.setInt(1, 2);
		stmt.addBatch();
