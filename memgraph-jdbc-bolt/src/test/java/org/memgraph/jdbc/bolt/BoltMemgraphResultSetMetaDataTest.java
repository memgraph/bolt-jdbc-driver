 ...
 * @since 3.0.0
 */
public class BoltMemgraphResultSetMetaDataTest {
	...
	@Test public void getColumnsCountShouldReturnCorrectNumberEmpty() throws SQLException {
		...
		ResultSetMetaData resultSet = BoltMemgraphResultSetMetaData.newInstance(false, Collections.EMPTY_LIST, resultIterator.keys());
	...
	@Test public void getColumnsCountShouldReturnCorrectNumberMoreElements() throws SQLException {
		...
		ResultSetMetaData resultSet = BoltMemgraphResultSetMetaData.newInstance(false, Collections.EMPTY_LIST, resultCursor.keys());
	...
	@Test public void getColumnNameShouldThrowExceptionWhenEmptyCursor() throws SQLException {
		...
		ResultSetMetaData resultSetMetaData = BoltMemgraphResultSetMetaData.newInstance(false, Collections.EMPTY_LIST, resultCursor.keys());
	...
	@Test public void getColumnNameShouldThrowExceptionIfCursorNull() throws SQLException {
		...
		ResultSetMetaData resultSet = BoltMemgraphResultSetMetaData.newInstance(false, Collections.EMPTY_LIST, Collections.EMPTY_LIST);
	...
	@Test public void flatteningTestWorking() throws SQLException {
		...
		ResultSetMetaData rsm = BoltMemgraphResultSetMetaData.newInstance(false, Collections.EMPTY_LIST,
	...
	@Test public void getColumnClassNameTest() throws SQLException {
		...
		ResultSetMetaData rsm = BoltMemgraphResultSetMetaData.newInstance(false, types, cols);
	...
	@Test public void getColumnTypeNameTest() throws SQLException {
		Result resultCursor = ResultSetData
				.buildResultCursor(ResultSetData.KEYS_RECORD_LIST_MORE_ELEMENTS_NODES, ResultSetData.RECORD_LIST_MORE_ELEMENTS_NODES);
		ResultSetMetaData rsm = BoltMemgraphResultSetMetaData.newInstance(false, Arrays.asList(new Type[] { InternalTypeSystem.TYPE_SYSTEM.NODE() }),
