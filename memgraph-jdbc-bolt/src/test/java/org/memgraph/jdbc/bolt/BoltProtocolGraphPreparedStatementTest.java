...
import org.memgraph.jdbc.bolt.data.StatementData;
import org.memgraph.jdbc.bolt.impl.BoltProtocolGraphConnectionImpl;
import org.memgraph.jdbc.bolt.utils.Mocker;
import org.memgraph.jdbc.impl.ListArray;
...
import static org.memgraph.jdbc.bolt.utils.Mocker.mockConnectionClosed;
import static org.memgraph.jdbc.bolt.utils.Mocker.mockOpenConnection;
import static org.memgraph.jdbc.bolt.utils.Mocker.mockOpenConnectionWithResult;
import static org.memgraph.jdbc.bolt.utils.Mocker.mockResultWithUpdateCount;

/**
 * @author AgileLARUS
 * @since 3.0.0
 */
public class BoltProtocolGraphPreparedStatementTest {

	@Rule
	public ExpectedException expectedEx = ExpectedException.none();

	private BoltProtocolGraphPreparedStatement preparedStatementOneParam;
	private BoltProtocolGraphPreparedStatement preparedStatementTwoParams;

	private BoltProtocolGraphResultSet expectedResultSet;
	private ResultSetFactory resultSetFactory;

	@Before public void interceptBoltResultSetConstructor() throws SQLException {
		expectedResultSet = mock(BoltProtocolGraphResultSet.class);
		resultSetFactory = (debug, statement, iterator, params) -> expectedResultSet;
		preparedStatementOneParam = new BoltProtocolGraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1");
		preparedStatementTwoParams = new BoltProtocolGraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1+$2");
	}
	...
	@Test public void closeShouldCloseExistingResultSet() throws Exception {
		...
		BoltProtocolGraphConnectionImpl connection = mockOpenConnectionWithResult(mockedDriverResult);
		BoltProtocolGraphPreparedStatement prStatement = new BoltProtocolGraphPreparedStatement(connection, resultSetFactory, "");
	...
	@Test public void closeShouldNotCallCloseOnAnyResultSet() throws Exception {
		PreparedStatement prStatement = BoltProtocolGraphPreparedStatement.newInstance(false, mockOpenConnectionWithResult(null), "");
	...
	@Test public void isClosedShouldReturnFalseWhenCreated() throws SQLException {
		BoltProtocolGraphConnectionImpl connection = mockOpenConnection();
		PreparedStatement prStatement = new BoltProtocolGraphPreparedStatement(connection, resultSetFactory, "");
	...
	@Test public void getParameterMetaDataShouldReturnANewParameterMetaData() throws Exception {
		BoltProtocolGraphParameterMetaData parameterMetaData = (BoltProtocolGraphParameterMetaData) preparedStatementOneParam.getParameterMetaData();
	...
	@Test public void getResultSetConcurrencyShouldThrowExceptionWhenCalledOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltProtocolGraphPreparedStatement.newInstance(false, mockConnectionClosed(), "");
		statement.close();
	...
	@Test public void executeQueryShouldThrowExceptionWhenClosedConnection() throws SQLException {
		...
		PreparedStatement statement = BoltProtocolGraphPreparedStatement.newInstance(false, mockConnectionClosed(), "", 0, 0, 0);
	...
	@Test public void executeQueryShouldReturnCorrectResultSetStructureConnectionNotAutocommit() throws Exception {
		...
		PreparedStatement statement = new BoltProtocolGraphPreparedStatement(mockOpenConnectionWithResult(null), (debug, stmt, iterator, params) -> {
			assertFalse(debug);
			assertNotNull(stmt);
			assertNull(iterator);
	...
	@Test public void executeQueryShouldThrowExceptionOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltProtocolGraphPreparedStatement.newInstance(false, mockOpenConnection(), StatementData.STATEMENT_MATCH_ALL);
		statement.close();
	...
	@Test public void executeUpdateShouldRun() throws SQLException {
		...
		PreparedStatement statement = BoltProtocolGraphPreparedStatement
	...
	@Test public void executeShouldRunQuery() throws SQLException {
		BoltProtocolGraphPreparedStatement statement = mock(BoltProtocolGraphPreparedStatement.class);
	...
	@Test public void executeShouldThrowExceptionOnUpdateOnClosedStatement() throws SQLException {
		...
		PreparedStatement statement = BoltProtocolGraphPreparedStatement.newInstance(false, mockOpenConnection(), StatementData.STATEMENT_CREATE);
		statement.close();
	...
	@Test public void getUpdateCountShouldReturnOne() throws SQLException {
		...
		BoltProtocolGraphPreparedStatement statement = new BoltProtocolGraphPreparedStatement(mockOpenConnectionWithResult(result), resultSetFactory, "RETURN 42");
		statement.executeUpdate();
	...
	@Test public void getUpdateCountShouldReturnMinusOne() throws SQLException {
		...
		BoltProtocolGraphPreparedStatement statement = new BoltProtocolGraphPreparedStatement(mockOpenConnection(), nullRsFactory, "RETURN 42");
	...
	@Test public void getResultSetShouldReturnNull() throws SQLException {
		BoltProtocolGraphStatement statement = mock(BoltProtocolGraphStatement.class);
	...
	@Test public void addBatchShouldAddParametersToStack() throws SQLException {
		BoltProtocolGraphPreparedStatement stmt = new BoltProtocolGraphPreparedStatement(mockOpenConnection(), resultSetFactory, "RETURN $1");
	...
	@Test public void addBatchShouldThrowExceptionIfClosedStatement() throws SQLException {
		...
		PreparedStatement stmt = BoltProtocolGraphPreparedStatement.newInstance(false, Mocker.mockOpenConnection(), "?");
		stmt.setInt(1, 1);
		stmt.close();
		stmt.addBatch();
	}
	...
	@Test public void executeBatchShouldWork() throws SQLException {
		...
		PreparedStatement stmt = BoltProtocolGraphPreparedStatement.newInstance(false, connection, "MATCH n WHERE id(n) = ? SET n.property=1");
		stmt.setInt(1, 1);
		stmt.addBatch();
		stmt.setInt(1, 2);
		stmt.addBatch();
	...
	@Test public void executeBatchShouldThrowExceptionOnError() throws SQLException {
		...
		BoltProtocolGraphConnection connection = (BoltProtocolGraphConnection) stmt.getConnection();
	...
	@Test public void executeBatchShouldThrowExceptionOnClosed() throws SQLException {
		...
		PreparedStatement stmt = BoltProtocolGraphPreparedStatement.newInstance(false, Mocker.mockConnectionClosed(), "?");
		stmt.setInt(1, 1);
		stmt.addBatch();
		stmt.setInt(1, 2);
		stmt.addBatch();
