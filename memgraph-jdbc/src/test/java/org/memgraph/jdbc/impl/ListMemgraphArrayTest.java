 ...
 * @since 3.0.0
 */
public class ListMemgraphArrayTest {
	...
	@Test public void getBaseTypeNameShouldReturnCorrectType() throws SQLException {
		...
		MemgraphArray array = new ListArray(list, Types.VARCHAR);
	...
	@Test public void getBaseTypeNameShouldThrowExceptionWhenNoMemgraphTypeProvided() throws SQLException {
		List<Object> list = new ArrayList<>();
		MemgraphArray array;
	...
	@Test public void getBaseTypeShouldThrowExceptionWhenNoMemgraphTypeProvided() throws SQLException {
		List<Object> list = new ArrayList<>();
		MemgraphArray array;
		for (int type : UNSUPPORTED) {
			try {
