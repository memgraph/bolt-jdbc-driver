 ...
 * @since 3.0.0
 */
public class GraphParameterMetaDataTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		GraphParameterMetaData parameterMetaData = mock(GraphParameterMetaData.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(parameterMetaData.isWrapperFor(GraphParameterMetaData.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(parameterMetaData.isWrapperFor(GraphResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(parameterMetaData.unwrap(GraphParameterMetaData.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		parameterMetaData.unwrap(GraphResultSet.class);
	}
}
