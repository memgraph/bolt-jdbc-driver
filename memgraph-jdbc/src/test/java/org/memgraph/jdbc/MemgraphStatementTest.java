 ...
 * @since 3.0.0
 */
public class MemgraphStatementTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		MemgraphStatement statement = mock(MemgraphStatement.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(statement.isWrapperFor(MemgraphStatement.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(statement.isWrapperFor(MemgraphParameterMetaData.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(statement.unwrap(MemgraphStatement.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		statement.unwrap(MemgraphResultSet.class);
	}
}
