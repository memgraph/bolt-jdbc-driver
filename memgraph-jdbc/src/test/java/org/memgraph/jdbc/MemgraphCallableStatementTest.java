 ...
 * @since 3.0.0
 */
public class MemgraphCallableStatementTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		MemgraphCallableStatement callableStatement = mock(MemgraphCallableStatement.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(callableStatement.isWrapperFor(MemgraphCallableStatement.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(callableStatement.isWrapperFor(MemgraphResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(callableStatement.unwrap(MemgraphCallableStatement.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		callableStatement.unwrap(MemgraphResultSet.class);
	}
}
