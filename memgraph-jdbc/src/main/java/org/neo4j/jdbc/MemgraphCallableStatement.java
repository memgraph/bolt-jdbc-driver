 ...
 * @since 3.0.0
 */
public abstract class MemgraphCallableStatement extends MemgraphPreparedStatement implements java.sql.CallableStatement {
	 ...
	 */
	protected MemgraphCallableStatement(MemgraphConnection connection, String rawStatement) {
	...
	@Override public MemgraphArray getArray(int parameterIndex) throws SQLException {
		throw ExceptionBuilder.buildUnsupportedOperationException();
	}
	...
	@Override public MemgraphArray getArray(String parameterName) throws SQLException {
		throw ExceptionBuilder.buildUnsupportedOperationException();
	}
