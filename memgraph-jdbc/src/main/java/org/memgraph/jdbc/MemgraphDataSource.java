 ...
 * @since 3.2.0
 */
public abstract class MemgraphDataSource implements javax.sql.DataSource {
	...
	static {
		try {
			Class.forName("org.memgraph.jdbc.MemgraphDriver");
		} catch (ClassNotFoundException e) {
			throw new IllegalStateException(
					"MemgraphDataSource is unable to load org.memgraph.jdbc.MemgraphDriver. Please check if you have proper Memgraph JDBC Driver jar on the classpath", e);
		}
	}
