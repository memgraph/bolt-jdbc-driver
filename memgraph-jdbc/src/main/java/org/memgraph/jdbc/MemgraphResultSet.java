 ...
 * @since 3.0.0
 */
public abstract class MemgraphResultSet implements ResultSet, Loggable {
	...
	public MemgraphResultSet(Statement statement, int... params) {
	 ...
	 *
	 * @throws SQLException if the {@link MemgraphResultSet} is closed
	 */
