 ...
 * @since 3.2.0
 */
public class MemgraphInvocationHandler implements InvocationHandler {

	private static final Logger LOGGER = Logger.getLogger(MemgraphInvocationHandler.class.getName());
	...
	public MemgraphInvocationHandler(Object target, boolean debug) {
		this.target = target;
		this.debug = debug;
