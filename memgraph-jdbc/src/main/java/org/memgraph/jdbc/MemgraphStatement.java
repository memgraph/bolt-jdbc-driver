 ...
 * @since 3.0.0
 */
public abstract class MemgraphStatement implements Statement, Loggable {

	protected MemgraphConnection connection;
	 ...
	 */
	protected MemgraphStatement(MemgraphConnection connection) {
	...
	@Override public MemgraphConnection getConnection() throws SQLException {
		this.checkClosed();
	...
	@Override public int getResultSetConcurrency() throws SQLException {
		...
		return MemgraphResultSet.DEFAULT_CONCURRENCY;
	}
	...
	@Override public int getResultSetType() throws SQLException {
		...
		return MemgraphResultSet.DEFAULT_TYPE;
	}
	...
	@Override public int getResultSetHoldability() throws SQLException {
		...
		return MemgraphResultSet.DEFAULT_HOLDABILITY;
	}
