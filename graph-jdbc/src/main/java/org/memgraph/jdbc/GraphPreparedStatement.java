 ...
 * @since 3.0.0
 */
public abstract class GraphPreparedStatement extends GraphStatement implements PreparedStatement {
	 ...
	 */
	protected GraphPreparedStatement(GraphConnection connection, String rawStatement) {
		super(connection);
