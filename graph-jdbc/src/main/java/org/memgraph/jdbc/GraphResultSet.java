 ...
 * @since 3.0.0
 */
public abstract class GraphResultSet implements ResultSet, Loggable {
	...
	public GraphResultSet(Statement statement, int... params) {
	 ...
	 *
	 * @throws SQLException if the {@link GraphResultSet} is closed
	 */
