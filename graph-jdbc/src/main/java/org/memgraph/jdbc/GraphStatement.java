 ...
 * @since 3.0.0
 */
public abstract class GraphStatement implements Statement, Loggable {
	 ...
	 */
	protected GraphStatement(GraphConnection connection) {
	...
	@Override public GraphConnection getConnection() throws SQLException {
		this.checkClosed();
	...
	@Override public int getResultSetConcurrency() throws SQLException {
		...
		return GraphResultSet.DEFAULT_CONCURRENCY;
	}
	...
	@Override public int getResultSetType() throws SQLException {
		...
		return GraphResultSet.DEFAULT_TYPE;
	}
	...
	@Override public int getResultSetHoldability() throws SQLException {
		...
		return GraphResultSet.DEFAULT_HOLDABILITY;
	}
