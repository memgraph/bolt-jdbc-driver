...
public class GraphConnectionTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		GraphConnection connection = mock(GraphConnectionImpl.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(connection.isWrapperFor(GraphConnection.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(connection.isWrapperFor(GraphStatement.class));
		assertFalse(connection.isWrapperFor(java.sql.Driver.class));
		assertFalse(connection.isWrapperFor(GraphResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(connection.unwrap(GraphConnection.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		connection.unwrap(GraphStatement.class);
	}
