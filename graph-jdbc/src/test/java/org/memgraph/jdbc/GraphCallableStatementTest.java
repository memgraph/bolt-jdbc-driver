 ...
 * @since 3.0.0
 */
public class GraphCallableStatementTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		GraphCallableStatement callableStatement = mock(GraphCallableStatement.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(callableStatement.isWrapperFor(GraphCallableStatement.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(callableStatement.isWrapperFor(GraphResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(callableStatement.unwrap(GraphCallableStatement.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		callableStatement.unwrap(GraphResultSet.class);
	}
}
