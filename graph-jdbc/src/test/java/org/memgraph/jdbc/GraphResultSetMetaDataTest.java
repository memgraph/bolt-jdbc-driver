 ...
 * @since 3.0.0
 */
public class GraphResultSetMetaDataTest {

	private GraphResultSetMetaData rsmd;

	@Rule public ExpectedException expectedEx = ExpectedException.none();

	@Before public void tearUp() throws SQLException {
		this.rsmd = mock(GraphResultSetMetaData.class, Mockito.CALLS_REAL_METHODS);
	}
	...
	@Test public void isNullableShouldReturnAlwaysNotNull() throws SQLException {
		assertEquals(this.rsmd.isNullable(0), GraphResultSetMetaData.columnNoNulls);
		assertEquals(this.rsmd.isNullable(-1), GraphResultSetMetaData.columnNoNulls);
		assertEquals(this.rsmd.isNullable(1), GraphResultSetMetaData.columnNoNulls);
	}
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		GraphResultSetMetaData resultSetMetaData = mock(GraphResultSetMetaData.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(resultSetMetaData.isWrapperFor(GraphResultSetMetaData.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(resultSetMetaData.isWrapperFor(GraphStatement.class));
		assertFalse(resultSetMetaData.isWrapperFor(java.sql.Driver.class));
		assertFalse(resultSetMetaData.isWrapperFor(GraphResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(resultSetMetaData.unwrap(GraphResultSetMetaData.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		resultSetMetaData.unwrap(GraphStatement.class);
	}
}
