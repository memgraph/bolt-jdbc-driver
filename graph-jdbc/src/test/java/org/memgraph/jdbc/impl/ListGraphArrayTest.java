 ...
 * @since 3.0.0
 */
public class ListGraphArrayTest {
	...
	@Test public void getBaseTypeNameShouldReturnCorrectType() throws SQLException {
		...
		GraphArray array = new ListArray(list, Types.VARCHAR);
	...
	@Test public void getBaseTypeNameShouldThrowExceptionWhenNoGraphTypeProvided() throws SQLException {
		List<Object> list = new ArrayList<>();
		GraphArray array;
	...
	@Test public void getBaseTypeShouldThrowExceptionWhenNoGraphTypeProvided() throws SQLException {
		List<Object> list = new ArrayList<>();
		GraphArray array;
		for (int type : UNSUPPORTED) {
			try {
