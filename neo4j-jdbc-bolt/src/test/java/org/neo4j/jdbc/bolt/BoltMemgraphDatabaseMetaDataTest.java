 ...
 * @since 3.0.0
 */
public class BoltMemgraphDatabaseMetaDataTest {
	...
	@Test public void getConnectionShouldGetConnection() throws SQLException {
		BoltMemgraphConnectionImpl connection = Mockito.mock(BoltMemgraphConnectionImpl.class, Mockito.RETURNS_DEEP_STUBS);
		BoltMemgraphDatabaseMetaData boltDatabaseMetaData = new BoltMemgraphDatabaseMetaData(connection);
