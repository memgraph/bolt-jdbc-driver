 ...
 * @since 3.0.0
 */
public class BoltMemgraphResultSetMetaData extends MemgraphResultSetMetaData {
	 ...
	 */
	private BoltMemgraphResultSetMetaData(List<Type> types, List<String> keys) {
		super(keys);
	...
	public static ResultSetMetaData newInstance(boolean debug, List<Type> types, List<String> keys) {
		ResultSetMetaData rsmd = new BoltMemgraphResultSetMetaData(types, keys);
		return (ResultSetMetaData) Proxy
				.newProxyInstance(BoltMemgraphResultSetMetaData.class.getClassLoader(), new Class[] { ResultSetMetaData.class }, new MemgraphInvocationHandler(rsmd, debug));
	}
